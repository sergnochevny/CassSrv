...
uses
  ...
  Forms, Dialogs, DB, IBHeader, IBExternals, IB, IBDatabase, Const_Type;
...
begin
  ...
  if TIBEvents( ptr).Queued then begin
    CloseHandle( CreateThread( nil, 8192, @HandleEvent, ptr, 0, vThreadID));
  end;
