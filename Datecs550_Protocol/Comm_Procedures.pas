...
//                          Parity, StopBits: Byte; CountDev: Integer; 
//                          var S_Info: TInfo): Boolean;
  function OpenConnection(Port_N: ShortInt; BaudRate: Cardinal; ByteSize,
...
//==============================================================================
//==============================================================================
//function Initialize_General_Struct(CountDev: Integer; var S_Info: TInfo): Boolean;
//var
//	H_Info: Cardinal;
//begin
//	Result := False;
...
//					ReadIntervalTimeout := tcReadIntervalTimeout;
//					ReadTotalTimeoutMultiplier := tcReadTotalTimeoutMultiplier;
//					ReadTotalTimeoutConstant := tcReadTotalTimeoutConstant;// div CountDev + 1;
//					WriteTotalTimeoutMultiplier := tcWriteTotalTimeoutMultiplier;
//					WriteTotalTimeoutConstant := tcWriteTotalTimeoutConstant;
//				end;
