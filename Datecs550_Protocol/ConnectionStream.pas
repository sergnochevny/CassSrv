...
{$endif}    
  ...
  public
    ...
    procedure CleanPort;
    procedure ClearBreakPort(_DevEnum: PDevEnum);
...
procedure TConnectionStream.ClearBreakPort(_DevEnum: PDevEnum);
begin
  ClearBreakCommPort( __S_Info );
//  _DevEnum^.Log.WriteToLog(PChar('ClearBreakPort'), Length('ClearBreakPort'));  
end;
