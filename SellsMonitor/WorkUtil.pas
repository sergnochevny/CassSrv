...
const
  __NoInfo      = 'ýýýýýýýýýý ýýýýýýýýýýý';
  __DiffFName   = 'ýýýýýýýýýýý ýý ýýýýý';
  __SoldFName   = 'ýýýýýýýýý ýýýýý';
  __AnnulFName  = 'ýýýýýýýýýýýýýý ýýýý';
  __ChecksFName = 'ýýýý';
  ...
  __ID        = 'ID';
  __SerNumber = 'SerNumber';      __fnSerNumber = 'ýýýýý';                   
  __Moment    = 'moment';         __fnMoment    = 'ýýýýý ýýýýýýýý';
  __Chknumber = 'chknumber';      __fnChknumber = 'ýýýýý ýýýý';
  __EcrPayID  = 'EcrPayID';
  __Paytype   = 'paytype';        __fnPaytype   = 'ýýýýýý';
  __TotalSTR  = 'TotalSTR';       __fnTotalSTR  = 'ýýýýý ýý ýýýýýýý';
  __TotalCHK  = 'TotalCHK';       __fnTotalCHK  = 'ýýýýý ýý ýýýý';
  __TotalDiff = 'TotalDiff';      __fnTotalDiff = 'ýýýýýýý';
  __Code      = 'code';           __fnCode      = 'ýýý ýýýýýý';
  __Name      = 'name';           __fnName      = 'ýýýýýýýýýýýý';
  __Price     = 'Price';          __fnPrice     = 'ýýýý';
  __Quantity  = 'Quantity';       __fnQuantity  = 'ýýýýýýýýýý';
  __Summa     = 'Summa';          __fnSumma     = 'ýýýýý';
  __Discount  = 'Discount';       __fnDiscount  = 'ýýýýýý';
  __Total     = 'Total';          __fnTotal     = 'ýýýýý';
  __GID       = 'GoodsID';
  ...
  resSaleCode       = 'ýýýýýý ýý ýýýý'; 
  resSaleBar        = 'ýýýýýý ýý ýýýýý-ýýýý';
  resSaleArt        = 'ýýýýýýý ýý ýýýýýýýý';
  resDiscount       = 'ýýýýýý';
  resPayment        = 'ýýýýýý';
  resInOut          = 'ýýýýýýýý/ýýýýýý';
  resNullCheck      = 'ýýýýýýý ýýý';
  resPrtPayment     = 'ýýýýýýýýý ýýýýýý';
  resQueryKey       = 'ýýýýýý ýý ýýýýý';
  resQeryDisc       = 'ýýýýýý ýýýýýý';
  resAnnul          = 'ýýýýýýýýýýýýý ýýýý';
  resRejectAnnul    = 'ýýýýýý ýýýýýýýýýýýýý';
  resError          = 'ýýýýýý ýýýýýýýý';
  resNoGoodsParam   = 'ýýýýý ýý ýýýýýý';
...
begin
  if ((Self.ActiveControl = dgWork) and (not dgWork.DataSource.DataSet.IsEmpty)) then begin
    InputString:= InputBox(Self.Caption, 'ýýýýýýý ý.ý. ýýýýý', '');
